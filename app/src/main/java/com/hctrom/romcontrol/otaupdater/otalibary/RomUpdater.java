...
import com.hctrom.romcontrol.otaupdater.otalibary.enums.Display;
import com.hctrom.romcontrol.otaupdater.otalibary.enums.Duration;
...
public class RomUpdater implements IRomUpdater {
    ...
    public RomUpdater(Context context) {
        ...
        this.iconResId = R.drawable.ota_ic_stat_name;
